...
def test_parse_cty_dat_3():
    pattern_map, exact_map = parse_cty_dat("tests/cty3.dat")
    assert exact_map == {'3A/4Z5KJ/LH': {'Monaco'}}
    assert pattern_map == {'3A': {'Monaco'}}

def test_parse_cty_dat_4():
    pattern_map, exact_map = parse_cty_dat("tests/cty4.dat")
    assert exact_map == {
          '9M2/PG5M': {'Spratly Islands'},
          '9M4SDX': {'Spratly Islands'},
          '9M4SLL': {'Spratly Islands'},
